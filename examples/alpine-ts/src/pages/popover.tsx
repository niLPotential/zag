...
export function Popover() {
  ...
  return (
    <main className="popover" x-data={JSON.stringify(state)}>
      <div data-part="root" x-id="['popover']" x-popover={`{${Object.keys(state)}, id: $id('popover')}`}>
        ...
        <template x-teleport="body" x-bind:disabled="!$popover.portalled">
          <div x-popover:positioner>
            <div data-testid="popover-content" className="popover-content" x-popover:content>
              <div x-popover:arrow>
        ...
        <Toolbar>
          <Controls state={state} controls={popoverControls} />
          <StateVisualizer />
        </Toolbar>
      </div>
    </main>
